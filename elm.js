			...
			case 'UpdatePointerPosition':
				...
				if (_n1) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{path: pathNew, pointerPosition: pos}),
						elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(
						_Utils_update(
...
var author$project$Main$cHeight = 500;
var author$project$Main$cWidth = 500;
...
var author$project$Main$offsetPosition = A3(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					elm$html$Html$Events$on,
					'mousemove',
					A2(elm$json$Json$Decode$map, author$project$Main$UpdatePointerPosition, author$project$Main$offsetPosition)),
...
var author$project$Main$pointToString = function (point) {
	var y = elm$core$String$fromFloat(point.b);
	var x = elm$core$String$fromFloat(point.a);
	return x + (',' + y);
};
...
var author$project$Main$view = function (model) {
	var y = (-model.pointerPosition.y) + elm$core$Basics$round(author$project$Main$cHeight / 2);
	var x = model.pointerPosition.x - elm$core$Basics$round(author$project$Main$cWidth / 2);
	...
	return A2(
		...
		_List_fromArray(
			[
				A2(elm$html$Html$Attributes$style, 'background-color', 'rgb(230,230,230)')
			]),
		_List_fromArray(
			[
				elm$html$Html$text(
